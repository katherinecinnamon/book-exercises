...
difference <- salaries$salaries_2017 - salaries$salaries_2018
print(max(difference))

# What was the name of the employee who recieved largest decrease in salary?
salaries[ (salaries$salaries_2017 - salaries$salaries_2018)== max(difference), "employees"]

# What was the average salary change?
salary_change <- salaries$salaries_2018 - salaries$salaries_2017
mean(salary_change)
...
# write.csv(salaries, file = salaries_csv.csv)
# wd <- getwd()
salaries_csv <- read.csv("salaries_csv.csv", stringsAsFactors = FALSE)
salaries_csv
